...
import { dummyCourses } from '../../assets/assets'; // 👈 import here
  ...
  return (
    <div className="text-center py-16 px-4 sm:px-8 bg-white">
      ...
      <button
        ...
        className="bg-cyan-600 hover:bg-cyan-700 text-white px-6 py-3 rounded-full text-lg transition duration-300 mb-12"
      >
        Show All Courses
      </button>
